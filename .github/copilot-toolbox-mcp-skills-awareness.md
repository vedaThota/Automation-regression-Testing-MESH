...
_Generated: 2026-06-16T12:50:14.501Z_
...
Workspace `mcp.json` _(folder: MESH)_

- **c:\Users\PankajGhosh\eclipse-workspace\MESH\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\PankajGhosh\AppData\Roaming\Code\User\mcp.json** — _File missing_
