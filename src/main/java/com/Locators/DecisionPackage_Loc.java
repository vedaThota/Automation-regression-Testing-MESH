...
public interface DecisionPackage_Loc {
	...
	public static final By clearStateMedicaid_Director = By.xpath("//*[text()='State Medicaid Director']/following::button[@title='Clear State Medicaid Director Selection' or @title='Clear Selection']");
